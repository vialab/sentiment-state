...
public class TwitterScore {
	...
	public static void main(String[] args) throws FileNotFoundException{
		...
		//Uncomment to set the port to 4567
		int port = 800;
		
		setPort(port); // sets the port

		System.out.println();
		System.out.println("Active Web links");
		System.out.println("localhost:"+port+"/check");
		System.out.println("localhost:"+port+"/twitter/<twitter name handler>");
		System.out.println();
